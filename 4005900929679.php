...
<body>
    ...
    <source type="image/jpeg" srcset="comp/images/logo-nivea.png">
			...
			<picture>
    <source type="image/webp" srcset="comp/images/4005900929679/4005900929679_00.webp">
    <source type="image/jpeg" srcset="comp/images/4005900929679/4005900929679_00.png">					
			<img src="comp/images/4005900929679/4005900929679_00.png" style="max-width: 100%;" alt="NIVEA" class="fade-revealUp">
</picture>
			</div>
			<div class="col-12 col-md-9 text-center">
				<h1 class="fade-h1 fade-revealUp">
                Facial Cellular Expert Lift Antissinais Avançado Dia FPS30
					<br><span>50ml</span>
				</h1>
			</div>
		</div>
				...
				<div id="prodCarousel" class="carousel slide" data-ride="carousel" data-interval="4000">
					<div class="carousel-inner">
						<div class="carousel-item active">
							...
							<picture>
    <source type="image/webp" srcset="comp/images/4005900929679/4005900929679_3.webp">
    <source type="image/jpeg" srcset="comp/images/4005900929679/4005900929679_3.jpg">					
							<img src="comp/images/4005900929679/4005900929679_3.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
						<div class="carousel-item">
							<div class="carousel-imgctn">
							<picture>
    <source type="image/webp" srcset="comp/images/4005900929679/4005900929679_4.webp">
    <source type="image/jpeg" srcset="comp/images/4005900929679/4005900929679_4.jpg">					
							<img src="comp/images/4005900929679/4005900929679_4.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
                        <div class="carousel-item">
							<div class="carousel-imgctn">
							<picture>
    <source type="image/webp" srcset="comp/images/4005900929679/4005900929679_5.webp">
    <source type="image/jpeg" srcset="comp/images/4005900929679/4005900929679_5.jpg">					
							<img src="comp/images/4005900929679/4005900929679_5.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
						<div class="carousel-item">
							<div class="carousel-imgctn">
							<picture>
    <source type="image/webp" srcset="comp/images/4005900929679/4005900929679_6.webp">
    <source type="image/jpeg" srcset="comp/images/4005900929679/4005900929679_6.jpg">					
							<img src="comp/images/4005900929679/4005900929679_6.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
					</div>
		...
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-6 text-center">
				...
				<div class="beneficios">
                    ...
                    <div class="fade-revealUp">
                    Revolucionário ativo BAKUCHIOL PURO
					</div>
                    <div class="fade-revealUp">
                    Fortalece a pele e melhora os contornos faciais 
					</div>
                    <div class="fade-revealUp">
		...
		<div class="row d-flex justify-content-center">
			<div class="col-12 text-center">
				...
				<div class="d-block d-md-none">
					<div class="modoUsoDiv" style="background-image: url('comp/images/4005900929679/4005900929679_7.jpg')">
					</div>
				</div>
				<div class="d-none d-md-block">
					<div class="modoUsoDiv-desktop" style="background-image: url('comp/images/4005900929679/4005900929679_7.jpg')">
					</div>
				</div>				
	...
	<div class="container-fluid containerD">
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-6 text-center">
				...
				<picture>
    <source type="image/webp" srcset="comp/images/4005900929679/4005900929679_8.webp">
    <source type="image/jpeg" srcset="comp/images/4005900929679/4005900929679_8.jpg">				
				<img src="comp/images/4005900929679/4005900929679_8.jpg" style="max-width: 100%;" alt="NIVEA" class="fade-revealUp">
</picture>
			</div>
		</div>
	</div>
		...
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-10 text-center">
				<video width="100%" height="auto" controls autoplay muted loop>
					<source src="comp/images/4005900929679/4005900929679_video.mp4" type="video/mp4">
