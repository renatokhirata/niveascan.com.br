...
<body>
    ...
    <source type="image/jpeg" srcset="comp/images/logo-nivea.png">	
			...
			<picture>
    <source type="image/webp" srcset="comp/images/4005900669285/4005900669285_00.webp">
    <source type="image/jpeg" srcset="comp/images/4005900669285/4005900669285_00.png">	
			<img src="comp/images/4005900669285/4005900669285_00.png" style="max-width: 100%;" alt="NIVEA" class="fade-revealUp">
</picture>
			</div>
				...
				<div id="prodCarousel" class="carousel slide" data-ride="carousel" data-interval="4000">
					<div class="carousel-inner">
						<div class="carousel-item active">
							...
							<picture>
    <source type="image/webp" srcset="comp/images/4005900669285/4005900669285_3.webp">
    <source type="image/jpeg" srcset="comp/images/4005900669285/4005900669285_3.jpg">	
							<img src="comp/images/4005900669285/4005900669285_3.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
						<div class="carousel-item">
							<div class="carousel-imgctn">
							<picture>
    <source type="image/webp" srcset="comp/images/4005900669285/4005900669285_4.webp">
    <source type="image/jpeg" srcset="comp/images/4005900669285/4005900669285_4.jpg">	
							<img src="comp/images/4005900669285/4005900669285_4.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
                        <div class="carousel-item">
							<div class="carousel-imgctn">
							<picture>
    <source type="image/webp" srcset="comp/images/4005900669285/4005900669285_5.webp">
    <source type="image/jpeg" srcset="comp/images/4005900669285/4005900669285_5.jpg">	
							<img src="comp/images/4005900669285/4005900669285_5.jpg" alt="NIVEA">
</picture>
							</div>
						</div>
					</div>
	...
	<div class="container-fluid containerTexto">
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-6 text-center">
                ...
                <b>Loção Hidratante NIVEA Óleos Essenciais Flor de Laranjeira </b> nutre a pele com cuidado, deixando-a macia e sequinha. Hidrata por 24h e ainda perfuma. Aproveite!
				</p>
				<h3 class="fade-revealUp">
                Para que serve?
				</h3>
		...
		<div class="row d-flex justify-content-center">
			<div class="col-12 text-center">
				...
				<div class="d-block d-md-none">
					<div class="modoUsoDiv" style="background-image: url('comp/images/4005900669285/4005900669285_6.jpg')">
					</div>
				</div>
				<div class="d-none d-md-block">
					<div class="modoUsoDiv-desktop" style="background-image: url('comp/images/4005900669285/4005900669285_6.jpg')">
					</div>
				</div>				
	...
	<div class="container-fluid containerD">
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-6 text-center">
				...
				<picture>
    <source type="image/webp" srcset="comp/images/4005900669285/4005900669285_7.webp">
    <source type="image/jpeg" srcset="comp/images/4005900669285/4005900669285_7.jpg">
				<img src="comp/images/4005900669285/4005900669285_8.jpg" style="max-width: 100%;" alt="NIVEA" class="fade-revealUp">
</picture>
			</div>
		</div>
	</div>
		...
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-10 text-center">
				<video width="100%" height="auto" controls autoplay muted loop>
					<source src="comp/images/4005900669285/4005900669285_video.mp4" type="video/mp4">
