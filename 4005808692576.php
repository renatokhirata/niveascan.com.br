					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<div class="carousel-imgctn">
								<picture>
									<source type="image/webp" srcset="comp/images/4005808692576/4005808692576_3.webp">
									<source type="image/jpeg" srcset="comp/images/4005808692576/4005808692576_3.jpg">	
						...
						<div class="carousel-item">
							<div class="carousel-imgctn">
								<picture>
									<source type="image/webp" srcset="comp/images/4005808692576/4005808692576_4.webp">
									<source type="image/jpeg" srcset="comp/images/4005808692576/4005808692576_4.jpg">	
						...
						<div class="carousel-item">
							<div class="carousel-imgctn">
								<picture>
									<source type="image/webp" srcset="comp/images/4005808692576/4005808692576_5.webp">
									<source type="image/jpeg" srcset="comp/images/4005808692576/4005808692576_5.jpg">	
						...
						<div class="carousel-item">
							<div class="carousel-imgctn">
								<picture>
									<source type="image/webp" srcset="comp/images/4005808692576/4005808692576_6.webp">
									<source type="image/jpeg" srcset="comp/images/4005808692576/4005808692576_6.jpg">	
		...
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-6 text-center">
				...
				<p class="fade-revealUp">
					Sabonete mousse para o rosto que limpa todas as impurezas e resíduos de maquiagem. Cuide bem da sua pele. Garanta o seu!
				</p>
				<h3 class="fade-revealUp">
					Para que serve?
				</h3>
				<p class="fade-revealUp">
					Rico em vitaminas, revigora a pele e deixa uma sensação refrescante. Equilibra a hidratação natural da pele.
				</p>
				<h3 class="fade-revealUp">
				...
				<div class="beneficios">
					...
					Com Vitamina E, essencial para pele saudável
					</div>
					<div class="fade-revealUp">
					Com Vitamina B5, que auxilia na renovação da pele
					</div>
					<div class="fade-revealUp">
